      ...
      <div className="relative flex flex-col items-center justify-center px-4 h-full">
        ...
        <div className="w-full max-w-md p-8 bg-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/30 shadow-2xl shadow-black/20">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white hover:bg-slate-100 text-slate-800 rounded-xl font-medium transition-colors shadow-lg"
          >
